...
void ofxOfeliaDefine::bangMethod()
{
    ...
    data.lua->doFunction(gensym("bang"));
}
...
void ofxOfeliaDefine::floatMethod(t_floatarg f)
{
    ...
    data.lua->doFunction(gensym("float"), f);
}
...
void ofxOfeliaDefine::symbolMethod(t_symbol *s)
{
    ...
    data.lua->doFunction(gensym("symbol"), s);
}
...
void ofxOfeliaDefine::pointerMethod(t_gpointer *p)
{
    ...
    data.lua->doFunction(gensym("pointer"), p);
}
...
void ofxOfeliaDefine::listMethod(t_symbol *s, int argc, t_atom *argv)
{
    ...
    data.lua->doFunction(gensym("list"), argc, argv);
}
...
{
    binbuf_addv(bb, const_cast<char *>("ssff"), gensym("#X"), gensym("obj"),
