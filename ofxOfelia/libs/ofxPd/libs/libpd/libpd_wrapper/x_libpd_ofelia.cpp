...
#if _MSC_VER
__declspec(dllexport) void ofelia_audio_lock();;
__declspec(dllexport) void ofelia_audio_unlock();
__declspec(dllexport) void ofelia_call_async(std::function<void()> fn);
__declspec(dllexport) void ofelia_set_run_loop(std::function<void()> fn);
#endif
